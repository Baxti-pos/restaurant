  ...
  return (
    <div className={clsx(
      ...
      <div className={clsx(
        ...
        isWaiter ? 'pb-[calc(4.75rem+env(safe-area-inset-bottom))] h-[100dvh]' : 'lg:ml-64 pb-20 lg:pb-0'
      )}>
        {!isWaiter && (
        ...
        <header className={clsx(
          ...
          <div className="flex justify-between items-center mb-1">
            ...
            <div className="relative">
              <button onClick={() => setProfileDropdown(!profileDropdown)} className="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center">
                <User className="h-4 w-4 text-indigo-600" />
              </button>
              {profileDropdown && (
                <div className="absolute top-full right-0 mt-1 w-48 bg-white rounded-xl shadow-lg border border-slate-200 py-1 z-50">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {showInstallAction && (
              <button onClick={handleInstall} className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold bg-indigo-600 text-white">
        ...
        <div className="flex justify-between items-center px-1">
          {filteredMobileTabs.map((tab) => {
            ...
            return (
              ...
              >
                <Icon className={clsx('h-6 w-6')} strokeWidth={isActive ? 2.5 : 2} />
