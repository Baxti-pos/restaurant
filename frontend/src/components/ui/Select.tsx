      ...
      <div className="w-full" data-baxti-select-root>
        ...
        <div className="relative">
          ...
          <button
            ...
            className={clsx(
              'baxti-select flex h-11 w-full items-center justify-between rounded-xl border border-slate-300 px-3 py-2 text-sm text-slate-700 transition-all duration-300 focus-visible:outline-none focus:ring-[3px] focus:ring-indigo-500/30 focus:border-indigo-500 disabled:cursor-not-allowed disabled:opacity-50',
