...
categoriesRouter.get("/", requireManagerAnyPermissions(["PRODUCTS_VIEW", "ORDERS_MANAGE"]), (req, res) =>
  categoriesController.list(req, res)
);
categoriesRouter.get("/:categoryId", requireManagerAnyPermissions(["PRODUCTS_VIEW", "ORDERS_MANAGE"]), (req, res) =>
