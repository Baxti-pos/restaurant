...
tablesRouter.get(
  ...
  (req, res) => tablesController.list(req, res)
);
...
tablesRouter.get(
  ...
  requireRoles(["OWNER", "MANAGER", "WAITER"]),
  requireManagerAnyPermissions(["TABLES_VIEW", "TABLES_MANAGE"]),
  (req, res) => tablesController.getById(req, res)
);
...
tablesRouter.get(
  ...
  (req, res) => tablesController.getQr(req, res)
);
...
tablesRouter.post(
  ...
  requireRoles(["OWNER", "MANAGER"]),
  requirePermissions(["TABLES_MANAGE"]),
  (req, res) => tablesController.create(req, res)
);
...
tablesRouter.patch(
  ...
  requireRoles(["OWNER", "MANAGER"]),
  requirePermissions(["TABLES_MANAGE"]),
  (req, res) => tablesController.update(req, res)
);

tablesRouter.post(
  "/:tableId/qr/regenerate",
  requireRoles(["OWNER", "MANAGER"]),
  requirePermissions(["TABLES_MANAGE"]),
  (req, res) => tablesController.regenerateQr(req, res)
);
...
tablesRouter.delete(
  ...
  requireRoles(["OWNER", "MANAGER"]),
  requirePermissions(["TABLES_MANAGE"]),
  (req, res) => tablesController.remove(req, res)
);
